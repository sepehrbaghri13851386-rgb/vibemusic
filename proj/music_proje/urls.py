...
urlpatterns = [
    ...
    path('artist/', views.artist_detail_default, name='artist_detail'),
    # صفحه هنرمند با ID
    path(
    ...
    path(
        'artist/<int:artist_id>/like/',
        honermandan_views.toggle_artist_like,
        name='toggle_artist_like'
    ),
    ...
    path(
        'genres/',
        genres_views.genre_list,
        name='genres'
    ),

    path(
        'genres/<slug:slug>/',
        genres_views.genre_detail,
        name='genre_detail'
    ),
    ...
    # BLOG
    # =====================================================
path('blog/', include('blog_app.urls')),  # ✅ تغییر اصلی
    ...
    path(
        '404/',
        views.not_found_demo,
        name='not_found_demo'
    ),

    path(
        '505/',
        views.server_error_demo,
        name='server_error_demo'
    ),
]
