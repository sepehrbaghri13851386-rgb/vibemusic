...
# Django 4.2+/6.0 style storage configuration (replaces the old
# DEFAULT_FILE_STORAGE / STATICFILES_STORAGE settings, which no
# longer have any effect on modern Django versions).
STORAGES = {
    "default": {
